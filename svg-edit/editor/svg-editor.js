...
// 									key: btn.key,
	...
	// 							}
			...
			var updateContextPanel = function() {
				...
				$('#selected_panel, #multiselected_panel, #g_panel, #rect_panel, #magic_panel, #circle_panel,\
...
// 					console.log('cm', $(evt.target).closest('.contextMenu'));
			...
			*/
			...
			var clickMagic = function(){
				if (toolButtonClick('#tool_magic')) {
					svgCanvas.setMode('magic')
				}
			}
		...
		// 		updateBgImage();
			...
			var updateWireFrame = function() {
				// Test support
				var rule = "#workarea.wireframe #svgcontent * { " +
		...
		// 	}
			...
			var Actions = function() {
				...
				var tool_buttons = [
					...
					{sel:'#tool_magic', fn:clickMagic, evt:'mouseup', key: ['M', true], parent: '#tools_magic', icon: 'magic'},
